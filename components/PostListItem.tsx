          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              {isBlog && (
                <>
                  <span className="text-gray-600 text-xs">·</span>
                  <span className="inline-flex items-center gap-1 px-1.5 py-0.5 bg-gradient-to-r from-retro-purple/20 to-retro-blue/20 border border-retro-purple/30 rounded text-retro-purple text-xs font-pixel">
