...
export default function PostsManagementPage() {
  ...
  const fetchPosts = async () => {
    try {
      ...
      const response = await fetch(`/api/pixel-dashboard/posts?${params}`)
  ...
  const handleAIReview = async (postId: string) => {
    try {
      ...
      const response = await fetch(`/api/pixel-dashboard/posts/${postId}/ai-review`, {
        method: 'POST'
      })
      const result = await response.json()
  ...
  const handleToggleActive = async (postId: string, currentStatus: boolean) => {
    ...
    try {
      ...
      const response = await fetch(`/api/pixel-dashboard/posts/${postId}/toggle-active`, {
        method: 'POST',
  ...
  const handleApprove = async (postId: string) => {
    ...
    try {
      ...
      const response = await fetch(`/api/pixel-dashboard/posts/${postId}/update-status`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
