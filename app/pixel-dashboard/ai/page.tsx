...
export default function AiAdminPage() {
    ...
    const fetchInitialData = async () => {
        ...
        try {
            const [npcsRes, desksRes, configsRes, usageRes] = await Promise.all([
                ...
                fetch('/api/pixel-dashboard/ai/config'),
                fetch('/api/pixel-dashboard/ai/usage')
            ])
    ...
    const saveConfig = async (config: any, index: number) => {
        ...
        try {
            const res = await fetch('/api/pixel-dashboard/ai/config', {
                method: 'POST',
    ...
    const deleteConfig = async (id: string, index: number) => {
        ...
        setStatus('正在删除配置...')
        try {
            const res = await fetch(`/api/pixel-dashboard/ai/config?id=${id}`, {
                method: 'DELETE'
            })
            if (res.ok) {
                setStatus('✅ 配置已删除')
    ...
    const testAi = async (config: any, index: number) => {
        ...
        try {
            const res = await fetch('/api/pixel-dashboard/ai/test', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify(config)
            })
