    ...
    async function fetchData() {
      try {
        ...
        const [adminResponse, statsResponse] = await Promise.all([
          fetch('/api/pixel-dashboard/auth/me'),
          fetch('/api/pixel-dashboard/dashboard/stats'),
        ])
    ...
    <div className="p-8">
      ...
      <div className="bg-gray-900 rounded-lg p-6 border border-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <button
            onClick={() => router.push('/pixel-dashboard/players')}
          ...
          <button
            onClick={() => router.push('/pixel-dashboard/workstations')}
